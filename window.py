...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Save_as_PushButton.setGeometry(QtCore.QRect(470, 280, 121, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Save_as_PushButton.sizePolicy().hasHeightForWidth())
        self.Save_as_PushButton.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        ...
        self.Open_PushButton.setGeometry(QtCore.QRect(280, 270, 171, 61))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.Combine_PushButton.setGeometry(QtCore.QRect(110, 290, 141, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.Percentage_Value = QtWidgets.QLineEdit(self.centralwidget)
        self.Percentage_Value.setGeometry(QtCore.QRect(220, 270, 31, 21))
        self.Percentage_Value.setInputMethodHints(QtCore.Qt.ImhDigitsOnly)
        self.Percentage_Value.setObjectName("Percentage_Value")
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setGeometry(QtCore.QRect(110, 270, 111, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Crop_X_Value_2.setText(_translate("MainWindow", "0"))
        self.Crop_Y_Value_1.setText(_translate("MainWindow", "0"))
        self.Crop_Y_Value_2.setText(_translate("MainWindow", "0"))
        ...
        self.Percentage_Value.setText(_translate("MainWindow", "0"))
        self.label_9.setText(_translate("MainWindow", "Percentage (0 -> 100)"))
